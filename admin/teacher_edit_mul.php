...
<div class="navbar navbar-default navbar-static-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            <a class="navbar-brand" title='EDIT TEACHER'>EDIT TEACHER</a>
        </div>
...
<div class="container">
<form method="post" action="teacher_update_mul.php">
...
{
	$id = $chk[$i];			
	$res=$MySQLiconn->query("SELECT * FROM teacher_tbl WHERE id_teacher=".$id);
	while($row=$res->fetch_array())
	{
		?>
		<tr>
		<td>
    	<input type="hidden" name="id[]" value="<?php echo $row['id_teacher'];?>" />
...
<a href="teacher_data.php" class="btn btn-large btn-success"> <i class="glyphicon glyphicon-fast-backward"></i> &nbsp; cancel</a>
</td>
</tr>
</table>
</form>
